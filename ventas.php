...
// Obtener todas las propiedades en venta
$query = "SELECT * FROM propiedades WHERE tipo = 'venta' ORDER BY fecha_creacion DESC";
...
<head>
    ...
    <title>Propiedades en Venta - UTN Solutions Real State</title>
...
<body>
    ...
    <header class="header">
        <div class="header-container">
            <div class="logo">
                <!-- Adding dynamic logo support like in index.php -->
        ...
        <div class="properties-container">
            ...
            <div class="properties-grid">
                ...
                <div class="property-card">
                    <!-- Adding dynamic image support for properties -->
